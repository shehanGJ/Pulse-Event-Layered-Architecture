...
public class CustSigninController {
    ...
    public void handleSignInButtonAction(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        // Login successful - go to welcome screen
            ...
            // store customer info
            LoggedInUsersDTO.initCust(c_idOrEmail);

            String msg = "You have just signed in to our system. If this was not you, then please contact us at sheahnanujayanewrole@gmail.com";
            EmailClass.sendEmail("Successful Login", msg, LoggedInUsersDTO.getCust().getEmail_address());
    ...
    public void goToMainMenu() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/main_menu.fxml"));
    ...
    public void goToRegister() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/cust_register.fxml"));
        Parent root = loader.load();

        //Get controller of register scene
        CustRegisterController controller = loader.getController();
