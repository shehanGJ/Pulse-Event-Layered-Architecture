...
public class CustMenuController
{
    ...
    public void setEventBookedStatus(String cust_id) {
        ...
        eventDTO = eventDTO.getEvent(cust_id,1);
    ...
    public void goToEditScreen() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/cust_edit.fxml"));
    ...
    public void goToSignIn() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/cust_signin.fxml"));
        Parent root = loader.load();
    ...
    public void goToViewEvent() throws IOException {
        ...
        if (controller.setEventDetails(LoggedInUsersDTO.getCust_id(), 1)) {
            // close current window
    ...
    public void goToBookEvent() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/event_book.fxml"));
        Parent root = loader.load();

        //Get controller of book event scene
        EventBookController controller = loader.getController();
