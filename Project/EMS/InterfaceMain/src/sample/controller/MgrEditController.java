...
public class MgrEditController {
    ...
    public void init() {
        ...
        EmployeeDTO emp = LoggedInUsersDTO.getEmp();
    ...
    public void handleSaveButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        // setting values
        EmployeeDTO emp = new EmployeeDTO(LoggedInUsersDTO.getEmp());
