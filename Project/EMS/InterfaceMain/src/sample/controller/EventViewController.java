...
public class EventViewController {
    ...
    public boolean setEventDetails(String id, int IDtype) {
        ...
        eventDTO = eventDTO.getEvent(id, IDtype);

        // getting all associated ids
        HashMap<String, String> IDs;
        IDs = eventDTO.getEventIDs(id, IDtype);
        ...
        // event found
            ...
            event_name.setText(eventDTO.getName());
            event_type.setText(eventDTO.getType());
            event_date.setText(eventDTO.getDate());
            event_time.setText(eventDTO.getStarting_time() + " to " + eventDTO.getEnding_time());
            event_guests.setText(Integer.toString(eventDTO.getTotal_guests()));
            event_price.setText(Integer.toString(eventDTO.getPrice()));
    ...
    public void setVenueDetails(String venue_id) {
        ...
        venueDTO = venueDTO.getVenue(venue_id);

        venue_name.setText(venueDTO.getName());
        venue_loc.setText(venueDTO.getLocation());
        venue_addr.setText(venueDTO.getVenue_address());
        venue_cap.setText(Integer.toString(venueDTO.getMax_capacity()));
        venue_cat.setText(venueDTO.getCategory());
        venue_contact.setText(venueDTO.getContact_info());
        venue_cost.setText(Integer.toString(venueDTO.getCost()));
    }
    ...
    public void setMenuDetails(String menu_id, String cat_id) {
        ...
        menuDTO = menuDTO.getMenu(menu_id);

        menu_bread.setText(menuDTO.getBread());
        if (menu_bread.getText().isEmpty())
            menu_bread.setText("Nothing selected");

        menu_rice.setText(menuDTO.getRice());
        if (menu_rice.getText().isEmpty())
            menu_rice.setText("Nothing selected");

        menu_protein.setText(menuDTO.getProtein());
        if (menu_protein.getText().isEmpty())
            menu_protein.setText("Nothing selected");

        menu_cost.setText(Integer.toString(menuDTO.getCost()));

        menu_miranda.setSelected(menuDTO.isMiranda());
        menu_coke.setSelected(menuDTO.isCoke());
        menu_sprite.setSelected(menuDTO.isSprite());
        menu_water.setSelected(menuDTO.isWater());

        menu_dryfruit.setSelected(menuDTO.isDryfruit());
        menu_sugarfree.setSelected(menuDTO.isSugarFree());

        menu_icecream.setSelected(menuDTO.isIcecream());
        menu_cake.setSelected(menuDTO.isCake());

        Catering_ServiceDTO caterer = new Catering_ServiceDTO();
    ...
    public void setStudioDetails(String studio_id) {
        ...
        studioDTO = studioDTO.getStudio(studio_id);

        studio_name.setText(studioDTO.getCompany_name());
        studio_contact.setText(studioDTO.getContact_info());
        studio_cost.setText(Integer.toString(studioDTO.getCost()));
    }
...
//        try {
//            // Path to your compiled JasperReport file (.jasper)
//            String reportPath = "src/sample/reports/EventReport.jrxml";
//
//            // Prepare parameters
//            HashMap<String, Object> parameters = new HashMap<>();
//            parameters.put("eventName", event_name.getText());
//            parameters.put("eventType", event_type.getText());
//            parameters.put("eventDate", event_date.getText());
//            parameters.put("eventGuests", Integer.parseInt(event_guests.getText()));
//            parameters.put("eventPrice", Integer.parseInt(event_price.getText()));
//
//            // Generate the report
//            JasperPrint print = JasperFillManager.fillReport(reportPath, parameters, new JREmptyDataSource());
//
