...
public class MgrSigninController {
    ...
    public void handleSignInButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        // Login successful - go to welcome screen
            ...
            if (emp.isManager(id)) {
                ...
                LoggedInUsersDTO.initEmp(id);

                // send email
                String msg = "You have just signed in to our system. If this was not you, then please contact us at shehananujayaownme@gmail.com";
                EmailClass.sendEmail("Successful Login", msg, LoggedInUsersDTO.getEmp().getEmail());
