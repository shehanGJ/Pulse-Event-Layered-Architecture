...
public class EmpSigninController {
    ...
    public void goToEmpEdit() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/emp_edit.fxml"));
        Parent root = loader.load();

        //Get controller of main menu scene
        EmpEditController controller = loader.getController();
        controller.init();
