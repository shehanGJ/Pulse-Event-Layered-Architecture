...
public class VenueEditController {
    ...
    public void handleSaveButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        venueDTO.editVenueField(venueIDs.get(0),"name", name, false);
        venueDTO.editVenueField(venueIDs.get(0), "location", loc, false);
        venueDTO.editVenueField(venueIDs.get(0), "address", addr, false);
        venueDTO.editVenueField(venueIDs.get(0), "max_capacity", cap, true);
        venueDTO.editVenueField(venueIDs.get(0), "category", cat, false);
        venueDTO.editVenueField(venueIDs.get(0), "contact_info", contact, false);
        venueDTO.editVenueField(venueIDs.get(0), "cost", price, true);
        ...
        // updating in database
        venueDTO.editVenueField(venueIDs.get(1),"name", name, false);
        venueDTO.editVenueField(venueIDs.get(1), "location", loc, false);
        venueDTO.editVenueField(venueIDs.get(1), "address", addr, false);
        venueDTO.editVenueField(venueIDs.get(1), "max_capacity", cap, true);
        venueDTO.editVenueField(venueIDs.get(1), "category", cat, false);
        venueDTO.editVenueField(venueIDs.get(1), "contact_info", contact, false);
        venueDTO.editVenueField(venueIDs.get(1), "cost", price, true);
        ...
        // updating in database
        venueDTO.editVenueField(venueIDs.get(2),"name", name, false);
        venueDTO.editVenueField(venueIDs.get(2), "location", loc, false);
        venueDTO.editVenueField(venueIDs.get(2), "address", addr, false);
        venueDTO.editVenueField(venueIDs.get(2), "max_capacity", cap, true);
        venueDTO.editVenueField(venueIDs.get(2), "category", cat, false);
        venueDTO.editVenueField(venueIDs.get(2), "contact_info", contact, false);
        venueDTO.editVenueField(venueIDs.get(2), "cost", price, true);
    ...
    public void goToVenueOptions() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/venue_edit.fxml"));
        Parent root = loader.load();

        //Get controller of employee ign in scene
        VenueEditController controller = loader.getController();
        controller.init();
