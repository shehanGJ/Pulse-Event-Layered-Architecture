...
public class StudioEditController {
    ...
    public void handleSaveButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        // update values
        studioDTO.editStudioField(studioIDs.get(0),"name",name,false);
        studioDTO.editStudioField(studioIDs.get(0),"contact_info",contact,false);
        studioDTO.editStudioField(studioIDs.get(0),"cost",cost,true);
        ...
        // update values
        studioDTO.editStudioField(studioIDs.get(1),"name",name,false);
        studioDTO.editStudioField(studioIDs.get(1),"contact_info",contact,false);
        studioDTO.editStudioField(studioIDs.get(1),"cost",cost,true);
        ...
        // update values
        studioDTO.editStudioField(studioIDs.get(2),"name",name,false);
        studioDTO.editStudioField(studioIDs.get(2),"contact_info",contact,false);
        studioDTO.editStudioField(studioIDs.get(2),"cost",cost,true);
    ...
    public void goToStudioOptions() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/studio_edit.fxml"));
        Parent root = loader.load();

        //Get controller of edit studios scene
        StudioEditController controller = loader.getController();
        controller.init();
