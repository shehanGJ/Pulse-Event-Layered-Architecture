...
import sample.dto.LoggedInUsersDTO;
...
public class MgrViewEmpController implements Initializable {

    //////////// TABLE VARIABLES ///////////////////

    @FXML private TableView MainTable;
    @FXML private TableColumn<EmployeeDTO, String> C_ID;
    @FXML private TableColumn<EmployeeDTO, String> C_FN;
    @FXML private TableColumn<EmployeeDTO, String> C_LN;
    @FXML private TableColumn<EmployeeDTO, String> C_CNIC;
    @FXML private TableColumn<EmployeeDTO, String> C_DOB;
    @FXML private TableColumn<EmployeeDTO, String> C_Email;
    @FXML private TableColumn<EmployeeDTO, String> C_Contact;
    @FXML private TableColumn<EmployeeDTO, String> C_Acc;
    @FXML private TableColumn<EmployeeDTO, String> C_MgrID;
    @FXML private TableColumn<EmployeeDTO, String> C_WageT;
    @FXML private TableColumn<EmployeeDTO, String> C_WageR;
    @FXML private TableColumn<EmployeeDTO, String> C_Points;
    ...
    private final ObservableList<EmployeeDTO> dataList = FXCollections.observableArrayList();

    /////////////////////////////////////////////////////////

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        C_ID.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("employee_id"));
        C_FN.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("fname"));
        C_LN.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("lname"));
        C_CNIC.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("cnic"));
        C_DOB.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("dob"));
        C_Email.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("email"));
        C_Contact.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("phone_no"));
        C_Acc.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("account_number"));
        C_MgrID.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("mgr_id"));
        C_WageT.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("wage_type"));
        C_WageR.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("wage_rate"));
        C_Points.setCellValueFactory(new PropertyValueFactory<EmployeeDTO, String>("points"));

        EmployeeDTO emp = new EmployeeDTO();
        ArrayList<EmployeeDTO> EmpList = emp.getListOfEmployees();
    ...
    public void setFilter(FilteredList<EmployeeDTO> filteredData) {
    ...
    public void loadTable() {
        ...
        FilteredList<EmployeeDTO> filteredData = new FilteredList<>(dataList, b -> true);
    ...
    public boolean checkAddInputs() throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        if (EmployeeDTO.checkIfEmailRegistered(Text_Email.getText())) { // email is already registered
    ...
    public void handleAddButtonAction(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        EmployeeDTO emp = new EmployeeDTO(f_name + " " + l_name, dob, contact, email, c_cnic, acc, w_t, Integer.parseInt(w_r), 0, mid);
        emp.addEmployee();
        dataList.addAll(emp);
    ...
    public void goToMgrMenu() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/mgr_menu.fxml"));
        Parent root = loader.load();

        //Get controller of menu scene
        MgrMenuController controller = loader.getController();
        controller.setName(LoggedInUsersDTO.getEmp().getName());
    ...
    public void goToEmpEdit(String empID) throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/mgr_edit_emp.fxml"));
        Parent root = loader.load();

        //Get controller of edit scene
        MgrEditEmpController controller = loader.getController();
