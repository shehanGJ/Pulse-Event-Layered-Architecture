...
public class MgrMenuController {
    ...
    public void goToMgrSignIn() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/mgr_signin.fxml"));
        Parent root = loader.load();

        //Get controller of sign in scene
        MgrSigninController controller = loader.getController();
    ...
    public void goToEventOptions() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/mgr_view_events.fxml"));
        Parent root = loader.load();

        //Get controller of event scene
        MgrViewEventsController controller = loader.getController();
        ...
        scene.getStylesheets().add(getClass().getResource("../resources/css/events_table_style.css").toExternalForm());
    ...
    public void goToCateringOptions() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/catering_edit.fxml"));
        Parent root = loader.load();

        //Get controller of catering scene
        CateringEditController controller = loader.getController();
        controller.init();
    ...
    public void goToEmpOptions() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/mgr_view_emp.fxml"));
        Parent root = loader.load();

        //Get controller of edit studios scene
        MgrViewEmpController controller = loader.getController();
        ...
        scene.getStylesheets().add(getClass().getResource("../resources/css/employees_table_style.css").toExternalForm());
    ...
    public void goToEditOptions() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../resources/view/mgr_edit.fxml"));
        Parent root = loader.load();

        //Get controller of edit scene
        MgrEditController controller = loader.getController();
        controller.init();
