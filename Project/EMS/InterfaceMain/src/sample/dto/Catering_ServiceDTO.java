...
import sample.dao.custom.impl.CateringServicesDAOImpl;

import java.util.ArrayList;
import java.util.HashMap;

public class Catering_ServiceDTO
{
    ...
    public Catering_ServiceDTO(String company_name, String contact_info, String speciality, int days, int charges) {
    ...
    public Catering_ServiceDTO getCaterer(String catering_id) {
