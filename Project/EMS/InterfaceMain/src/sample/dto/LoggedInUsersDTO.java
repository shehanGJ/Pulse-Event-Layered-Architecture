...
public class LoggedInUsersDTO {
    private static String cust_id;
    private static CustomerDTO cust = new CustomerDTO();

    private static String emp_id;
    private static EmployeeDTO emp = new EmployeeDTO();
    ...
    public static void setCust_id(String cust_id) {
        LoggedInUsersDTO.cust_id = cust_id;
    }
    ...
    public static CustomerDTO getCust() {
        return cust;
    }
    public static void setCust(CustomerDTO cust) {
        LoggedInUsersDTO.cust = cust;
    }
    ...
    public static void setEmp_id(String emp_id) {
        LoggedInUsersDTO.emp_id = emp_id;
    }

    public static EmployeeDTO getEmp() {
        return emp;
    }
    public static void setEmp(EmployeeDTO emp) {
        LoggedInUsersDTO.emp = emp;
    }
