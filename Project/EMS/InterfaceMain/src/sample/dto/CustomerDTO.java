...
public class CustomerDTO
{
    ...
    public CustomerDTO(String name, String cnic, int age, String contact_info, String email_address, String account_number, int priority_status)
    {
        this.name = name;
        this.cnic = cnic;
        this.age = age;
    ...
    public void getCustomerDetails(String id) {
        CustomerDAOImpl obj = new CustomerDAOImpl();
        CustomerDTO temp = obj.getCustomer(id);
