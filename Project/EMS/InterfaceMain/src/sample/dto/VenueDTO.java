...
import sample.dao.custom.impl.VenueDAOImpl;
...
public class VenueDTO
{
    ...
    public VenueDTO(String name, String location, String venue_address, int max_capacity, String description, String category, String contact_info, int cost) {
        this.name = name;
    ...
    public VenueDTO getVenue(String venue_id) {
